...
public class Funcionamiento extends Thread{
    private JLabel eti;
    private carreraNormal i;
    Funcionamiento(JLabel eti,carreraNormal i){
        this.eti=eti;
        this.i=i;
    }
    ...
    public void run(){
        ...
        carreraNormal.inicia.setEnabled(false);
        carreraNormal.otra.setEnabled(true);
    }
